...
<link rel="stylesheet" href="../Css/page%20style.css"/>    
    ...
    <title>Accept Happiness List</title>
    </head>
<body>
    ...
    <b><font face="Verdana" size="2" color="#FFFFFF">Accept Happiness List</font></b></td>
        ...
        <table border="1" width="100%" id="table110" cellspacing="0" cellpadding="0" height="auto" bordercolorlight="#C0C0C0" bordercolordark="#FFFFFF">
         ...
         <td width="220" bgcolor="#171717" align="left" height="28"><font face="Verdana" style="font-size: 9pt" color="#FFFFFF">ID</font></td>
...
?>
            ...
            <td width="47" align="center" height="30" bgcolor="#FFFFFF">
                ...
                <td width="120" height="30" bgcolor="#FFFFFF" align="center">
									<font face="Verdana" style="font-size: 9pt"><a href="../Happiness GH Letter List/Accept%20btn.html"><?php echo $res['status']; ?></a></font></td>

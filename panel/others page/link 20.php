...
$select_1 = "SELECT * FROM gh WHERE Status='Orders Created(+)';";
...
$total_gh=0;
 ...
 ?>
										...
										<?php $total_gh += (float)$res_1['Amount']; }?>	
                ...
                <td valign="top"><form method="POST" action="" name="ph_form">
							<table border="1" width="696" height="74" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#078F3F">
											<tbody><tr>
												...
												<font face="Verdana" size="2" color="#FFFFFF">
												Commit No</font></td>
												<td bgcolor="#003300" align="center" width="163" class="style1">
												<font face="Verdana" size="2" color="#FFFFFF">
												Date</font></td>
...
<?php
$select = "SELECT * FROM ph WHERE Participant = '$user_name' AND Payment_mood='20%-80%'  AND Bonus = 'MARVO 30%' AND Status='Orders Created(+)';";
...
$row = mysqli_num_rows($run); $total_ph=0;
 ...
 ?>
 												<tr>
													...
													<td width="54" height="23" align="center">
													<font face="Verdana" size="2">
													<input type="hidden" name="txtamountw-<?php echo $j; ?>" size="11" value="<?php echo $res['Amount']; ?>"><?php echo $res['Amount']; ?><?php echo $res['Type_c']; ?></font></td>
													<td width="50" height="23" align="center">
													<font face="Verdana" size="2">
													</font></td>
													<td width="64" height="23" align="center">
													<input type="text" name="txtadjamt-<?php echo $j; ?>" size="6"></td>
													<td width="53" height="23" align="center">
													<input type="text" name="txtordernow-<?php echo $j; ?>" size="6"></td>
												</tr>
											<?php $total_ph += (float)$res['Amount']; } ?>
												
												<tr>
													<td width="68" height="23" align="center">
													<input type="submit" value="Submit" name="submit_ph_adjust"><input type="hidden" name="txttotal" size="8" value="15"></td>
													<td width="68" height="23" align="center">&nbsp;
													</td>
													<td width="68" height="23" align="center">&nbsp;
													</td>
											...
											</tbody></table></form><?php adjustPhGh(); ?>

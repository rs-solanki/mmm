...
$select_1 = "SELECT * FROM gh WHERE (Status='Orders Created(+)' OR Status='Process') AND Balance>0 AND record_type='Main';";//exit;
...
<?php
echo $select = "SELECT * FROM ph WHERE Payment_mood='100%'  AND Bonus = 'MARVO 30%' AND gh_id='' AND (Status='Orders Created(+)' OR Status='Process');";

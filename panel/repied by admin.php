       ...
       <tr>
        ...
        <td width="100" bgcolor="#171717" align="center" height="28"><font face="Verdana" size="2" color="#FFFFFF">From Member</font></td>      
         <td width="100" bgcolor="#171717" align="center" height="28"><font face="Verdana" style="font-size: 9pt" color="#FFFFFF">Subject</font></td>
            ...
            <td width="150" bgcolor="#171717" align="center" height="28"><font face="Verdana" style="font-size: 9pt" color="#FFFFFF">CRO Name</font></td>
            <td width="150" bgcolor="#171717" align="center" height="28"><font face="Verdana" style="font-size: 9pt" color="#FFFFFF">CRO Reply </font></td>
...
<?php           
$select = "SELECT * FROM `tickets` WHERE Status = 'Yes'";
            ...
            <td width="47" bgcolor="white" align="center" height="28"><font face="Verdana" color="black" style="font-size: 9pt"><?php echo $run['Id']; ?></font></td>
             <td width="47" bgcolor="white" align="center" height="28"><font face="Verdana" color="black" style="font-size: 9pt"><?php echo $run['Msg_date']; ?></font>
                 ...
                 <td width="47" bgcolor="white" align="center" height="28"><font face="Verdana" color="black" style="font-size: 9pt"><?php echo $run['Msg']; ?></font></td>
                  <td width="47" bgcolor="white" align="center" height="28"><font face="Verdana" color="black" style="font-size: 9pt"><?php echo $run['CRO_name']; ?></font></td>
                   <td width="47" bgcolor="white" align="center" height="28"><font face="Verdana" color="black" style="font-size: 9pt"><?php echo $run['CRO_reply']; ?></font></td>
                 ...
                 <td width="47" bgcolor="white" align="center" height="28"><font face="Verdana" color="black" style="font-size: 9pt"><a href="Send%20Mail%20To%20Member%20Inbox.php?name=<?php echo $run['User_id']; ?>">Reply</a></font>
                </td>

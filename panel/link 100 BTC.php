...
$select_1 = "SELECT * FROM gh WHERE (Status='Orders Created(+)' OR Status='Process') AND Balance>0 AND record_type='Main' AND Select_currency = 'BTC';";//exit;
                ...
                <td valign="top"><form method="POST" action="" name="ph_form_100">
							<table border="1" width="696" height="74" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#078F3F">
											<tbody><tr>
												...
												<font face="Verdana" size="2" color="#FFFFFF">
												Commit No</font></td>
												<td bgcolor="#003300" align="center" width="150" class="style1">
												<font face="Verdana" size="2" color="#FFFFFF">
												Date</font></td>
...
<?php
echo $select = "SELECT * FROM ph WHERE Select_currency = 'BTC' AND Bonus = 'MARVO 30%' AND gh_id='' AND (Status='Orders Created(+)' OR Status='Process');";
...
$row = mysqli_num_rows($run); $total_ph=0;
 ...
 ?>
												...
												<tr>
													...
													<td align="center" height="23" width="650">
													<font face="Verdana" size="2">
													<?php echo $res['Order_date']; ?></font></td>
													<td align="center" height="23" width="102">
													<font face="Verdana" size="2">
													<input type="hidden" name="txtmemb_codew-<?php echo $j; ?>" size="9" value="<?php echo $res['Participant']; ?>"><?php echo $res['Participant']; ?></font></td>
													<td width="212" height="23" style="padding-left: 5px">
													<font face="Verdana" size="2">
													<?php echo $res['Participant_email']; ?></font></td>
													<td width="212" height="23" style="padding-left: 5px">
													  uniqueplus </td>
													<td width="54" height="23" align="center">
													<font face="Verdana" size="2">
    ...
    <div style="margin-top: 30px">
        <input type="text" name="" value="" id="txt"> <input type="button" name="" value="Check" class="ok" onclick="per_sent();">
        <p>20% :<span id="demo"></span></p>	
        <p> Balance :<span id="rem"></span></p>
        </div>

<script type="text/javascript">
function per_sent(){
    var ele =document.getElementById("txt").value;
    var result = document.getElementById("demo").innerHTML =  ele*20/100;
    var  rem  = document.getElementById("rem").innerHTML = ele - result; 
}
</script>

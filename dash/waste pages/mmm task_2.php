...
<div class="taks_name" style="padding: 20px; box-sizing: border-box;">
        <h2><span class="task_number"><?php echo $result['task_name']; ?></h2>    
        <span style="font-weight: 600;"><?php echo $result['task_tag'];?></span>
<span style="font-weight: 600; margin-left: 100px;">Task code :<input type="text" name="task_code" value="<?php echo $result['task_code'];?>" 
   style="border: none; background: none; font-weight: 600;" disabled></span>
        <br><br>
        <span style="font-size: 17px; font-weight: 600; line-height: 20px;">Follow the link <a href="<?php echo $result['link'];;?>"><?php echo $link_name;?></a>Write an original comment to the photo and attach one of the three suggested hashTags.And Your referral link.</span>    
        </div>
